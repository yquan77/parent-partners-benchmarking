...
window.MALAY_SLIDES = [
  ...
  },
  {
    ...
    text: "Percubaan pertama saya tidak berjalan selancar yang dijangka kerana peranan dan jangkaan belum dijelaskan."
  },
  {
    label: "Suara ibu bapa",
    text: "Mengurus beberapa orang murid sahaja pun sudah membuatkan ibu bapa kelam-kabut—apatah lagi seorang guru yang perlu mengendalikan seluruh kelas."
  },
  {
    label: "Realiti pertama",
    text: "Hanya lima orang ibu bapa hadir pada kali pertama, dan kelas itu masih kelam-kabut."
  },
  {
    label: "Apa yang dirasai anak",
    text: "Bagi anak, kehadiran ibu bapa di dalam kelas ialah pengalaman yang menggembirakan—dan ingin mereka alami lagi."
  },
  {
    label: "Apa yang diminta anak",
    text: "Seorang murid malah berharap ibunya dapat datang ke kelas setiap hari dan belajar bersamanya."
  },
  {
    label: "Perkara yang benar-benar penting",
    text: "Murid menghargai apabila seorang dewasa duduk di sisi dan menemaninya menyiapkan sesuatu yang diusahakannya sendiri."
  },
  {
  ...
  {
    label: "Gagasan kedua",
    text: "Sistem ini bukan sekadar untuk menambah bantuan di dalam kelas, tetapi untuk memberi setiap anak satu lagi peluang untuk mendapat perhatian."
  },
  {
  ...
  },
  {
    ...
    text: "Dengan tujuh kumpulan kecil, setiap murid berpeluang menerangkan sendiri hasil tulisannya."
  },
  {
    label: "Batas seorang guru",
  ...
  },
  {
    ...
    text: "Apabila objektif pembelajaran difahami bersama, ibu bapa mampu menghasilkan bahan dan menyediakan pengalaman yang benar-benar menyokong pembelajaran."
  },
  {
  ...
  {
    label: "Pembelajaran yang menyala",
  ...
  },
  {
    ...
    text: "Ini bukan kerana saya kebetulan mendapat ibu bapa yang “lebih baik”; dalam kelas baharu, ketika saya belum mengenali sesiapa pun, sebelas orang ibu bapa tetap hadir."
  },
  {
    label: "Tiga tahun dalam angka",
    text: "Sebanyak 44 aktiviti dan 278 penyertaan ibu bapa telah direkodkan, tetapi kepercayaan dibina melalui mutu setiap interaksi—bukan semata-mata kekerapannya."
  },
  {
    label: "Perkara yang diubah",
    text: "Yang saya ubah bukan ibu bapa, tetapi sistem."
  },
  {
    label: "Orang yang sama, kesedaran yang sama",
    text: "Selepas lima bulan, dalam dua mata pelajaran yang berbeza, kesimpulannya tetap sama: dengan bimbingan yang sesuai, anak sebenarnya mampu."
  },
  {
    label: "Perubahan yang lebih besar",
    text: "Hasil perubahan selama tiga tahun ini bukan sekadar sebuah sistem; semakin ramai orang dewasa di dalam kelas yang percaya bahawa anak mampu melakukannya."
  },
  {
  ...
  },
  {
    ...
    text: "Jika ada dua pasang tangan tambahan dalam bahagian pelajaran ini, adakah pengalaman pembelajaran murid akan berubah?"
  },
  {
    label: "Soalan kedua",
  ...
  {
    label: "Penutup",
    text: "Saya bukan bermula kerana sudah mempunyai ibu bapa yang baik. Selepas saya bermula, barulah terbentuk pasukan ibu bapa ini—dan anak-anak mula mengambil kembali tanggungjawab terhadap pembelajaran mereka sendiri."
  },
  {
  ...
  {
    label: "Terima kasih",
    text: "Terima kasih kerana sudi mengikuti perkongsian ini."
  }
];
