...
HTML slide deck目前共47页，主要内容、真实照片、马来文实时跟页、来源脚注与参考文献页都已完成。最近完成第10页师生比动画调整：进入页面时只显示 `1:35`、一位老师与35位学生；讲者第一次按「下一页」后，先出现7位家长与组框，再执行7组×5人的分组动画；动画结束后再次按键才进入第11页。
